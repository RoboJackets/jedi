...
return [
    ...
    */
    ...
    'proxy' => array_filter([
        ...
        'no' => null === env('NO_PROXY') ? null : explode(',', str_replace(' ', '', env('NO_PROXY'))),
    ]),
    ...
    */
    ...
    'notify_release_stages' => null === env('BUGSNAG_NOTIFY_RELEASE_STAGES') ? null : explode(
        ',',
        str_replace(
            ' ',
            '',
            env('BUGSNAG_NOTIFY_RELEASE_STAGES')
        )
    ),
